"""Generate the distributed multi-K Sunway GEMM project."""
...
def main() -> None:
    ...
    parser.add_argument("--compute", choices=("scalar", "simd"), default="scalar")
    ...
    target["gemm_compute"] = args.compute
    artifact = tilelang.lower(gemm_128_k64, target=target, runtime_only=True)
    shutil.copy2(Path(__file__).with_name("gemm_128_k64_main.c"), args.output_dir)
