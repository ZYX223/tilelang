"""Generate the non-square scalar-GEMM Sunway AOT project."""
...
def gemm_m32_n16_k32(
    ...
    with T.Kernel(1, 2, threads=64) as (bx, by):
...
def main() -> None:
    ...
    shutil.copy2(Path(__file__).with_name("gemm_m32_n16_k32_main.c"), args.output_dir)
